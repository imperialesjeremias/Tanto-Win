  ...
  return (
    <div className="flex flex-col w-11/12 m-4 md:m-7">
      <div className="flex items-center justify-center">
        <h1 className="text-4xl font-plainRegular mb-2 md:mb-4 md:text-5xl">
          Contacto
        </h1>
      </div>
      <div className="flex items-center justify-center">
          ...
          <div className="flex flex-col w-full mt-4 gap-2 md:mt-6">
            ...
            <label className="input input-bordered flex items-center gap-2 bg-transparent border-2 border-b-gray-533 text-gray-533 md:border-4 md:input-lg">
              <input
                type="text"
                className="grow"
                placeholder="Entidad representante"
              />
            </label>
            ...
            <textarea
              className="textarea textarea-bordered bg-transparent border-2 border-b-gray-533 text-gray-533 md:border-4"
              placeholder="Mensaje adicional"
            ></textarea>
            <button className="btn bg-transparent text-white md:btn-lg">
              Button
            </button>
          </div>
